...
---
Upload files to S3 with bash, file2img, minimalist css, Drupal + AMP, Drupal MKT material, kwyboard+wifi+ESP8266, Deep Natural Processing lecture slides, Trax: state of the art deep learning lib, Feymans PHD thesis, Engagin infographics and slides, Yannick Corboz.
