...
- Apple II resources & demos
- Online Petscii editor for C64
...
- **Apple II Programming FAQ** - [FAQ with a lot of links and resources](http://apple2.org.za/gswv/a2zine/faqs/csa2pfaq.html)
- **Beagle brothers programs** - https://mirrors.apple2.org.za/ground.icaen.uiowa.edu/apple8/Beagle.Oldies/
- **Asimov** - This FTP has **huge** amounts of technical documents, magazines and source code. [[FTP]](ftp://ftp.apple.asimov.net/pub/apple_II/)
- **Vendors and publishers** - [Vendors/publishers list](http://apple2.org.za/gswv/a2zine/faqs/A2FAQs3VENDORS.html)
...
- **Dos and ProDos documentation** - [[FTP]](ftp://ftp.apple.asimov.net/pub/apple_II/documentation/os/)
...
- **Emulators** - For Linux there is [LinApple](http://linapple.sourceforge.net/) and a fork in [Github](https://github.com/dabonetn/linapple-pie). These are both ports of [AppleWin](https://github.com/AppleWin). Currently development happens in this [[Github repo]](https://github.com/linappleii/linapple)
...
- **Textfiles** - [Apple related textfiles](http://www.textfiles.com/apple/)
- **Nibble magazine archive** - This site has a lot of resources from Nibble magazine including **all** listings downloadable. [[web]](http://nibblemagazine.com/)
- **Call Apple** -"World's Largest Apple User Group - Since 1978" [[web]](https://www.callapple.org/)
- **Apple II ROM Disassembly** - This pages has the commented code of the ROMS of the Apple II with lots of comments. [[web]](https://6502disassembly.com/a2-rom/)
- **Apple II Disk Browser** - Cross platform browser of disk images. It allows you to look at sectors and disassemble the code in them. [[github]](https://github.com/dmolony/DiskBrowser)
![Disk Browser screenshot](imgs/2020-04-27/apple-2-disk-browser.png)
- **Applesauce** - Applesauce is a floppy drive controller for connecting vintage Apple II 5.25″ and 3.5″ floppy drives up to your modern computer via a USB connection. [[web]](https://applesaucefdc.com/)
![AppleSauce image 1](imgs/2020-04-27/applesauce-1.png)
![AppleSauce image 2](imgs/2020-04-27/applesauce-2.png)
- **6502bench SourceGen** - 6502bench is a code development "workbench" for the 65xx family of processors, including the 6502, 65C02, and 65802/65816. It currently features one tool, the SourceGen disassembler. [[Github]](https://github.com/fadden/6502bench/) [[web]](https://6502bench.com/)
...
- **Apple Commander** - "AppleCommander is a cross-platform set of tools used to manipulate Apple ][ disk images.". [[web]](https://applecommander.github.io/) [[GitHub]](https://github.com/AppleCommander)
- **dae353b** - Sizecoding for the Apple II. A 353b demo. [[Pouet]](https://www.pouet.net/prod.php?which=85046) [[YoTube]](https://www.youtube.com/watch?v=lcQ58VM9s2A)
- FRENCH TOUCH VAULT - This site has several Apple II releases. [[web]](http://fr3nch.t0uch.free.fr/)
- Digidream - A release by fr3nch.t0uch: [[web minipage]](http://fr3nch.t0uch.free.fr/DD/DD.html). [[GitHub]](https://github.com/Fr3nchT0uch/digidream)
- Mad Effect #3 - Another demo by FTV. [[web]](http://fr3nch.t0uch.free.fr/MAD3/MAD3.html) [[YouTube]](https://www.youtube.com/watch?v=jkn9m9lV1ig)

![MAD3 image 1](imgs/2020-04-27/mad3-00.png)
![MAD3 image 3](imgs/2020-04-27/mad3-02.png)

## Online Petscii editor for C64

This is an awesome web-based PETSCII editor: [petscii editor webapp](http://petscii.krissz.hu). Really complete: it allows you to add sprites, much better really that Petmate. unfoctunately there is no source code or repo o downloadable version.

## Sony a6000, a6300, a6500, a6400, a6100 and a6600 comparison

![Sony a6000 lineup](imgs/2020-04-27/a6000-line.png)
...
![Compofiller screenshot](imgs/2020-04-27/compofiller_studio_screenshot_800.jpeg)
...
![Wackelkontakt capture 3](imgs/2020-04-27/wackelkontakt-03.png)
...
- Shadertoy version of Wackelkontakt - [Shadertoy implementation of demo](https://www.shadertoy.com/view/ts2yWm)
- Slerpy shader toy url: [Slerpy user Shadertoy profile](https://www.shadertoy.com/user/slerpy)
- Oidos additive synthesizer - [[GitHub]](https://github.com/askeksa/Oidos) was highly recommended. [[Pouet]](https://www.pouet.net/prod.php?which=69524)

More screenshots:

![Wackelkontakt capture 1](imgs/2020-04-27/wackelkontakt-01.png)
![Wackelkontakt capture 2](imgs/2020-04-27/wackelkontakt-02.png)
![Wackelkontakt capture 4](imgs/2020-04-27/wackelkontakt-04.png)
![Wackelkontakt capture 5](imgs/2020-04-27/wackelkontakt-05.png)
![Wackelkontakt capture 6](imgs/2020-04-27/wackelkontakt-06.png)
![Wackelkontakt capture 7](imgs/2020-04-27/wackelkontakt-07.png)

### Resimulated - Winner of PC 64K Intro in Javascript

I don't remember seening this demo but it won the PC 64K Intro and is written in Javascript. The code is available [[@GitHub]](https://github.com/gam0022/resimulated). Lots of interesting things to investigate.

![Resimulated JavaScript 64k demo](imgs/2020-04-27/resimulated.jpeg)

### Links 🔗

- Twitter post with demo - [[twitter]](https://twitter.com/gam0022/status/1249658268319768576)
- YouTube video - [[YouTube]](https://youtu.be/tirAdWbceak)
